<?php
define ('MAILTO', "KRV-HVL@gmx.de"); // Empfänger hier eintragen
...
<div id="container"> 
  ...
  <div id="middle"> 
    <div id="navigation"> <a href="index.html" class="main">Wir über uns</a> <a href="vorstand.html" class="sub">Vorstand</a> <a href="aufgaben.html" class="main">Aufgaben & Ziele</a> <a href="veranstaltungen.html" class="main">Veranstaltungen KRV / Termine </a> <a href="ergebnisse kreismeisterschaft.html" class="main">Ergebnisse Kreismeisterschaft Havelland</a> <a href="Vereine des KRV.html" class="main">Vereine des KRV</a> <a href="interessantelinks.html" class="main">Interessante Links</a> <a href="reitatlas/start.html" target="_blank" class="main">Reitatlas</a> <a href="impressum.html" class="main">Impressum</a> </div> 
    <div id="content"> 
 <h1>Kontakt</h1>      
<?php
